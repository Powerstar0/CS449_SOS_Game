...
class ComputerPlayer(Player):
    ...
    def make_LLM_move(self, board_size, matrix_list):
        ...
        for i in range(board_size):
            translated_cell_matrix_columns = []
            for j in range(board_size):
                translated_cell_matrix_columns.append(matrix_list[i][j]["text"])
            translated_cell_matrix_rows.append(translated_cell_matrix_columns)
        print(translated_cell_matrix_rows)
