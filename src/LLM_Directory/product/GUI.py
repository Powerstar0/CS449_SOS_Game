...
class SOS:
    ...
    def left_frame_panel(self):
        ...
        record_game_button = ttk.Checkbutton(self.left_frame, text="Record", variable=self.record_game_var,
                                             onvalue=True, offvalue=False,
                                             command=self.boardgame.recorded_game_update(self.record_game_var.get()))
