...
class TestGameStartConditions:
    ...
    def test_board_creation(self, setup_logic):
        """Ensure a new Board is created when valid board size is given."""
        logic = setup_logic
        logic.board_size = 5
        ...
        assert logic.turn.get() == "Current Turn: Blue"

    # -----------------------------
    # 3.2 Simple Game Mode Initialization
    # -----------------------------
    def test_simple_game_initialization(self, setup_logic):
        """Ensure that 'Simple Game' mode initializes properly."""
        logic = setup_logic
    ...
    def test_general_game_initialization(self, setup_logic):
        """Ensure that 'General Game' mode initializes properly."""
        logic = setup_logic
    ...
    def test_blank_board_size(self, setup_logic):
        """Ensure that blank board size triggers an error message."""
        logic = setup_logic
    ...
    def test_blank_game_mode_defaults_to_simple(self, setup_logic):
        """Ensure that blank game mode defaults to 'Simple Game'."""
        logic = setup_logic
    ...
    def test_blank_board_size_and_game_mode_defaults(self, setup_logic):
        """Ensure that missing board size and game mode defaults to valid values."""
        logic = setup_logic
        logic.board_size = ""
        logic.game_type = StringVar(value="Simple Game")
